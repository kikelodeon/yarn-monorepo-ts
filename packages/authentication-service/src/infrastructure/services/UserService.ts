// packages/authentication-service/src/infrastructure/services/UserService.ts

import { DatabaseConnectionError } from'@custom/shared/infrastructure/errors';

import { User } from '../../domain/entities/User';
import { UserId } from '@custom/shared/domain/valueObjects/UserId';
